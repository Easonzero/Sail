...
scene.add(new Sail.Rectangle([2.13,5.488,2.27],[3.43,5,3.32],matte,Sail.Color.createTexture([0,0,0]),[6,6,6]));
scene.add(new Sail.Cube([0,0,-7],[5.560,5.488,5.592],matte,cornellbox));

//scene.add(new Sail.Sphere([1.5,1.25,2.70],1.2,mirror,Sail.Color.createTexture([1,1,1])));
scene.add(new Sail.Sphere([3.9,1.25,1.70],1.2,metal,Sail.Color.createTexture([1,1,1])));
scene.add(camera);
