...
scene.add(new Sail.Rectangle([2.13,5.488,2.27],[3.43,5,3.32],matte,Sail.Color.create([0,0,0]),[6,6,6]));
...
scene.add(new Sail.Sphere([3.9,1.25,1.70],1.2,glass,Sail.Color.create([1,1,1])));
scene.add(camera);
